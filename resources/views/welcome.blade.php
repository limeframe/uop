                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        <div class="p-6">
                            ...
                            <div class="mt-2 sm:mt-2 sm:flex-none">
                                <a href="" class="inline-flex text-xs items-center justify-center rounded-md border border-transparent bg-indigo-600 px-2 py-2 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">ΠΕΡΙΣΣΟΤΕΡΑ</a>
                            </div>
                        </div>
